...
contract IKIP17Metadata is IKIP17 {
    ...
    function officialSite() external view returns (string memory);
...
contract KIP17Metadata is KIP13, KIP17, IKIP17Metadata {
     ...
     * @dev Constructor function
     */
    constructor (string memory name, string memory symbol, string memory officialSite) public {
        _name = name;
        _symbol = symbol;
...
contract KIP17Full is KIP17, KIP17Enumerable, KIP17Metadata {
    constructor (string memory name, string memory symbol, string memory officialSite) public KIP17Metadata(name, symbol, officialSite) {
...
contract Pooya is KIP17Full, KIP17MintableOwnable, KIP17MetadataMintableOwnable, KIP17Burnable, KIP17Pausable {
    constructor (string memory name, string memory symbol, string memory officialSite) public KIP17Full(name, symbol, officialSite) {
    }
}